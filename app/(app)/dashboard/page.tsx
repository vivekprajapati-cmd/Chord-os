...
function StatCard({ label, value, highlight = false }: {
  ...
  return (
    <div style={{
      ...
      <p style={{ fontFamily: 'var(--f-mono)', fontSize: '10px', letterSpacing: '0.06em', textTransform: 'uppercase', color: 'var(--gray)', marginBottom: '10px' }}>
        {label}
      </p>
      <p style={{ fontFamily: 'var(--f-display)', fontSize: 'clamp(40px, 5vw, 56px)', fontWeight: 400, textTransform: 'uppercase', lineHeight: 1, color: 'var(--ink)' }}>
        {value}
      </p>
    </div>
  );
