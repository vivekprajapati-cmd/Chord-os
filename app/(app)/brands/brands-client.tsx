...
export default function BrandsClient({
  ...
  // brands that have at least one client account, or show all brands if none
  const brandsWithAccounts = initialBrands.filter(b => accountsByBrand[b.id]?.length > 0);
  const brandsWithoutAccounts = initialBrands.filter(b => !accountsByBrand[b.id]?.length);
              ...
              return (
                ...
                >
                  ...
                  <div style={{
                    ...
                    padding: '14px 20px',
                    borderBottom: accounts.length > 0 ? '1px solid var(--line)' : 'none',
                    ...
                    <p style={{ fontFamily: 'var(--f-mono)', fontSize: '12px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                      {b.name}
                      <span style={{ marginLeft: '10px', fontWeight: 400, color: 'var(--gray)', fontSize: '10px' }}>
