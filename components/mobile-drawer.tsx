...
type Tier = 'admin' | 'lead' | 'operations' | 'hr' | 'poc' | 'staff';
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ padding: '24px 20px 20px', borderBottom: '1px solid var(--line)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <button
            onClick={() => setOpen(false)}
            style={{ background: 'none', border: 'none', fontSize: '22px', color: 'var(--gray)', cursor: 'pointer', lineHeight: 1 }}
          >
            ×
          </button>
        </div>
        ...
        <div style={{ padding: '16px 20px', borderTop: '1px solid var(--line)' }}>
          ...
          <p style={{ fontFamily: 'var(--f-mono)', fontSize: '9px', color: 'var(--gray)', textTransform: 'uppercase', letterSpacing: '0.08em', marginTop: '2px' }}>{role}</p>
          {tier !== 'staff' && (
